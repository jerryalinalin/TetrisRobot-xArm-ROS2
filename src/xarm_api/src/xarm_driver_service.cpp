...
namespace xarm_api
{
    ...
    {
        RCLCPP_WARN(node_->get_logger(), "set_rs485_use_503_port not supported in this SDK version");
        res->ret = 0;
        res->message = "data=" + std::to_string(req->data);
        return true;
    }
    ...
    bool XArmDriver::_set_external_device_monitor_params(const std::shared_ptr<xarm_msgs::srv::SetInt16List::Request> req, std::shared_ptr<xarm_msgs::srv::SetInt16List::Response> res)
    {
        ...
        RCLCPP_WARN(node_->get_logger(), "set_external_device_monitor_params not supported in this SDK version");
        res->ret = 0;
